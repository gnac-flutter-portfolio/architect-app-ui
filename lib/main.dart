...
class ArchitectUI extends StatefulWidget {
  const ArchitectUI({super.key});

  @override
  State createState() => _ArchitectUIState();
}
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: const Color(0xFFF5B788), width: 3)),
                          child: Row(
...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = const Color(0xFF2B4A5B);
